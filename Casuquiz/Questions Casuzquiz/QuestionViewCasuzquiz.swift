...
struct QuestionViewCasuzquiz: View {
    @Environment(\.dismiss) var dismiss
    @StateObject var vm: QuestionViewModelCasuzquiz
   ...
   var wtgv = 14143514514
    ...
    init(type: GameTypeCasuzquiz) {
        _vm = StateObject(wrappedValue: QuestionViewModelCasuzquiz(typeOfGame: type))
    }
